    ...
    <>
      <section className={styles.center}>
        <div className={styles.hero}>
          <img src={heroImg} className={styles.hero__base} width="170" height="179" alt="" />
          <img src={reactLogo} className={styles.hero__framework} alt="React logo" />
          <img src={viteLogo} className={styles.hero__vite} alt="Vite logo" />
        </div>
        <div>
          <h1>Get started</h1>
          <p>
